...
- Hiển thị danh sách quán theo khoảng cách từ GPS hiện tại, có bộ lọc 5km/5-15km/không giới hạn và phân trang.
...
Danh sách phải được sắp xếp từ gần đến xa, có phân trang và có bộ lọc giới hạn
khoảng cách: 5km, 5-15km, hoặc không giới hạn. Các mốc filter hiển thị phải
được khai báo trong config frontend chung.
...
Google Maps URL. Endpoint phải hỗ trợ lọc theo bán kính dương, khoảng cách tối
thiểu cho filter dạng khoảng và phân trang, trong khi frontend chỉ hiển thị các
mốc 5km, 5-15km, hoặc không giới hạn khoảng cách.
...
- Bổ sung yêu cầu hiển thị khoảng cách GPS, sort gần đến xa và lọc theo bán kính trên endpoint danh sách quán.
- Chốt frontend dùng config chung cho các mốc filter khoảng cách.

## v1.2
- Cập nhật mốc filter danh sách quán thành 5km/5-15km/không giới hạn.
- Bổ sung yêu cầu phân trang cho danh sách quán gần bạn nhất.
