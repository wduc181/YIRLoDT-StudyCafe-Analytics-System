...
5km, 10km, hoặc không giới hạn. Các mốc filter hiển thị phải được khai báo trong
config frontend chung.
...
Google Maps URL. Endpoint phải hỗ trợ lọc theo mọi bán kính dương, trong khi
frontend chỉ hiển thị các mốc 5km, 10km, hoặc không giới hạn khoảng cách.
...
- Chốt frontend dùng config chung cho các mốc 5km/10km/không giới hạn.
